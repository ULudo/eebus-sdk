...
class MockShipPeer:
    ...
    async def _send_data(self, connection: ServerWebSocketConnection, payload: dict[str, Any]) -> None:
    ...
    async def _handle_client(self, reader: asyncio.StreamReader, writer: asyncio.StreamWriter) -> None:
        ...
        while True:
            ...
            if msg_type != SHIP_MSG_CONTROL:
                raise ConnectionError("expected SHIP control during access negotiation")
            ...
            if "accessMethods" in payload:
                break
            raise ConnectionError("unexpected SHIP control during access negotiation")
